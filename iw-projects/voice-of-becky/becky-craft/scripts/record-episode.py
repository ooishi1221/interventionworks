...
EP_NUM = "011"
EP_TITLE = "鉄を捨ててダイヤへ — y=-58への潜行"
GOAL = ("今日はエピソード11の本番収録。本編シーズン1の続き、テーマは「ダイヤ深層探索」。"
        "【前回までのあらすじ】前回 EP.010 は「鉄装備で拠点整備」に挑んだが、因縁のドラウンドとの死闘で"
        "また敗れ、持ち物は全ロストした。デスはしなかったが装備は何も残っていない。"
        "鉄は、シリーズ通して10エピソードやってまだ一度も手にしていない。"
        "【今日の私】持ち物は完全にゼロからの再出発。道具作りはもう手慣れたもの、迷いはない。"
        "【今日の目標】方針転換。鉄には固執せず、一気に深く掘ってダイヤ層（y=-58 帯）を目指す。"
        "dig_down でまっすぐ掘り進め、ダイヤ鉱石を1個でも見つけられたら今日は勝ち。"
        "深く潜るほど溶岩とドラウンド以外の敵にも会いやすくなる。丸石や土で足場を作りながら慎重に進むこと。"
        "松明があれば視界確保に使う。水の中には入らない（ドラウンドは天敵）、"
        "夜に地上で敵に囲まれたら無理せず退避、体力が減ったら安全確保を最優先。"
        "鉄を持たないままダイヤ層へ挑む無謀さも隠さず実況に乗せること。"
        "【オープニングの定型】一言目は必ず「はろー、ベキたんです！ベッキークラフト、第11回、"
        "いっくよー！」から始めて、「今日は鉄を諦めて、一気にダイヤ層まで潜る」の"
        "宣言をしてから出発する。"
        "観測の broadcast.remaining_sec が放送の残り秒数。時間配分を意識して動くこと。"
        "残り90秒を切ったら今日の成果（どこまで潜れたか・ダイヤは見つかったか）を振り返って締めに入り、"
        "最後のセリフは必ず「バイバイ」で終えて action は stop を選ぶこと。それまでは絶対に締めない")
HUD_GOAL = "ダイヤ深層探索 — y=-58を目指す"
...
def tts(text: str, out_path: Path, voice: dict | None = None):
    aivis_engine.ensure()  # 生きてれば数msで抜ける。落ちてたら起動して待つ（2026-08-04）
