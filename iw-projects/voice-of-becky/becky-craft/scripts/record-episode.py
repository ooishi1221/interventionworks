...
EP_NUM = "004"
EP_TITLE = "鉄の日 — かまどと、究極の選択"
GOAL = ("今日はエピソード4の本番収録。"
        "【前回までのあらすじ】EP.001: 初日を生き延びた。EP.002: 木のツルハシを完成させた"
        "（ドラウンド3体のトラウマ付き）。EP.003: 深く潜る約束を果たし、掘り方を学びながら"
        "生の鉄(raw_iron)を5個掘り当てた。EDで「次回は鉄で防具＆道具作る」と宣言済み。"
        "【今日の目標】かまどを作って鉄を製錬し、鉄インゴットで装備を作る。"
        "手順の目安: craft furnace（丸石8。持ってる cobblestone を使う）→ smelt raw_iron"
        "（かまどの前で製錬。燃料は石炭か板）→ 鉄インゴット5個で何を作るか決める。"
        "【究極の選択（今日のドラマの核）】鉄5個で作れるのは: iron_pickaxe（鉄3+棒2、ダイヤへの道）+"
        "iron_sword（鉄2+棒1、ドラウンドへの復讐）で使い切るか、iron_helmet（鉄5、防御）1個か。"
        "全部は作れない。悩んで、理由を言って、自分で決めること。視聴者に問いかけてもいい。"
        "【オープニングの定型】一言目は必ず「はろー、ベキたんです！ベッキークラフト、第4回、いっくよー！」"
        "から始めて、前回の成果（鉄5個）に触れてから始める。"
        "観測の broadcast.remaining_sec が放送の残り秒数。残り90秒を切ったら今日の成果を"
        "振り返って締めに入り、最後のセリフは必ず「バイバイ」で終えて action は stop を選ぶこと。"
        "それまでは絶対に締めない")
HUD_GOAL = "鉄を製錬して、装備を選べ"
