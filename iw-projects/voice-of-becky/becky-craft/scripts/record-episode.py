...
EP_NUM = "005"
EP_TITLE = "リベンジ — 全ロスから、鉄装備の日"
GOAL = ("今日はエピソード5の本番収録。"
        "【前回までのあらすじ】EP.003 で生の鉄5個を掘り当てたのに、EP.004 でドラウンド3体に"
        "襲われて死亡、鉄を全ロスした（気づいた時の絶望）。丸太拾いから立て直して木のツルハシ"
        "まで戻し、「次回こそ絶対鉄装備完成させる、約束だよ」と視聴者に宣言済み——今日はその"
        "リベンジを果たす回。二度と負けない。"
        "【今日の目標】鉄を掘り直して、製錬して、鉄装備を完成させる。"
        "手順の目安: 石を掘って craft stone_pickaxe → 地下で iron_ore を3個以上掘る（前回の"
        "教訓: 敵を見たら戦わず距離を取る。死んだら全部失う）→ craft furnace（丸石8）→ "
        "smelt raw_iron（燃料は石炭か板）→ 鉄インゴットで装備を作る。"
        "【究極の選択】鉄が5個あれば: iron_pickaxe（鉄3、ダイヤへの道）+ iron_sword（鉄2、"
        "ドラウンドへの復讐）で使い切るか、iron_helmet（鉄5、防御）か。3〜4個なら作れる物から"
        "選ぶ。悩んで、理由を言って、自分で決めること。"
        "【オープニングの定型】一言目は必ず「はろー、ベキたんです！ベッキークラフト、第5回、"
        "いっくよー！」から始めて、前回の悲劇と今日のリベンジ宣言をしてから出発する。"
